...
export default function Footer({
  ...
  return (<div className="py-20 bg-green-900 text-white mt-10">
    <div className="container mx-auto">
        <div className="text-2xl leading-80">
          <Edit filter="logo_slogen" />
          {slogen.desc}
        </div>
        <div className="flex flex-row">
          {slogen.name && <p className="flex-1">
            <Edit filter="logo_slogen" />
          ...
          <p className="flex-1">
            ...
            <a key={k} target="_blank" className="text-white hover:text-green-300" href={v.action}>{v.name}</a><br /></>))}
